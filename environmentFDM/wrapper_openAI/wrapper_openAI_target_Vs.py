...
class WrapperOpenAI (gym.Env):
    ...
    def reset(self):
        ...
        # set targets
        self.targetValues['targetSpeed'] = np.random.uniform(38, 45)  # m/s
    ...
    def user_defined_observation(self, aircraft_state_f_ks):
        ...
        aircraft_state_f_ks = np.asarray(
            [current_u, current_u_to_target_u, self.integration_error_stepsize_for_u, current_theta, current_q])
